...
/*can-util@3.0.0-pre.35#js/assign/assign*/
...
/*can-util@3.0.0-pre.35#js/is-array-like/is-array-like*/
...
/*can-util@3.0.0-pre.35#js/is-iterable/is-iterable*/
...
/*can-util@3.0.0-pre.35#js/each/each*/
...
/*can-set@0.6.0-pre.9#src/clause*/
...
/*can-util@3.0.0-pre.35#js/make-array/make-array*/
...
/*can-set@0.6.0-pre.9#src/compare*/
...
/*can-util@3.0.0-pre.35#js/is-empty-object/is-empty-object*/
...
/*can-set@0.6.0-pre.9#src/set-core*/
...
/*can-util@3.0.0-pre.35#namespace*/
define('can-util/namespace', function (require, exports, module) {
    module.exports = {};
});
/*can-set@0.6.0-pre.9#src/props*/
define('fixture-can-set/src/props', function (require, exports, module) {
    var h = require('fixture-can-set/src/helpers');
    var clause = require('fixture-can-set/src/clause');
    var each = require('can-util/js/each/each');
...
/*can-connect@0.6.0-pre.19#connect*/
define('fixture-can-connect/connect', function (require, exports, module) {
    var assign = require('can-util/js/assign/assign');
...
/*can-connect@0.6.0-pre.19#base/base*/
define('fixture-can-connect/base/base', function (require, exports, module) {
...
/*can-connect@0.6.0-pre.19#can-connect*/
...
/*can-util@3.0.0-pre.35#js/is-array/is-array*/
define('can-util/js/is-array/is-array', function (require, exports, module) {
    module.exports = function (arr) {
        return Array.isArray(arr);
    };
});
/*can-connect@0.6.0-pre.19#helpers/get-items*/
...
/*can-connect@0.6.0-pre.19#helpers/sorted-set-json*/
...
/*can-connect@0.6.0-pre.19#helpers/overwrite*/
...
/*can-connect@0.6.0-pre.19#helpers/set-add*/
...
/*can-connect@0.6.0-pre.19#helpers/get-index-by-id*/
...
/*can-connect@0.6.0-pre.19#data/memory-cache/memory-cache*/
