...
/*can-set@0.6.0-pre.8#src/helpers*/
...
/*can-set@0.6.0-pre.8#src/clause*/
...
/*can-set@0.6.0-pre.8#src/compare*/
...
/*can-set@0.6.0-pre.8#src/set-core*/
...
define('fixture-can-set/src/props', function (require, exports, module) {
    ...
    props.offsetLimit = function (offsetProp, limitProp) {
        return props.paginate(offsetProp || 'offset', limitProp || 'limit', function (set) {
    ...
    props.rangeInclusive = function (startIndexProperty, endIndexProperty) {
        return props.paginate(startIndexProperty || 'start', endIndexProperty || 'end', function (set) {
            var except = {};
