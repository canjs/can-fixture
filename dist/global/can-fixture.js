...
/*can-util@3.10.14#js/assign/assign*/
...
/*can-util@3.10.14#js/is-array-like/is-array-like*/
...
/*can-util@3.10.14#js/is-iterable/is-iterable*/
...
define('fixture-can-set/src/helpers', [
    'require',
    'exports',
    'module',
...
define('fixture-can-set/src/clause', [
    'require',
    'exports',
    'module',
    'can-util/js/assign/assign',
...
/*can-util@3.10.14#js/make-array/make-array*/
...
define('fixture-can-set/src/compare', [
    'require',
    'exports',
    'module',
    'fixture-can-set/src/helpers',
    'can-util/js/assign/assign',
    'can-util/js/each/each',
...
define('fixture-can-set/src/get', [
    'require',
    'exports',
    'module',
    'fixture-can-set/src/compare',
    'fixture-can-set/src/helpers',
    'can-util/js/each/each'
], function (require, exports, module) {
...
define('fixture-can-set/src/set-core', [
    'require',
    'exports',
    'module',
    'fixture-can-set/src/helpers',
    'fixture-can-set/src/clause',
    'fixture-can-set/src/compare',
    'fixture-can-set/src/get',
    'can-util/js/assign/assign',
    'can-util/js/each/each',
    'can-util/js/make-array/make-array',
...
define('fixture-can-set/src/props', [
    'require',
    'exports',
    'module',
    'fixture-can-set/src/helpers',
...
define('fixture-can-set/src/set', [
    'require',
    'exports',
    'module',
    'fixture-can-set/src/set-core',
    'can-namespace',
    'fixture-can-set/src/props',
    'fixture-can-set/src/clause',
    'fixture-can-set/src/helpers'
], function (require, exports, module) {
    var set = require('fixture-can-set/src/set-core');
    var ns = require('can-namespace');
    var props = require('fixture-can-set/src/props');
    var clause = require('fixture-can-set/src/clause');
...
/*can-util@3.10.14#js/is-container/is-container*/
...
/*can-util@3.10.14#js/is-array/is-array*/
...
/*can-util@3.10.14#js/string/string*/
...
/*can-connect@2.0.0-pre.2#connect*/
define('fixture-can-connect/connect', [
    'require',
    'exports',
    'module',
    'can-util/js/assign/assign'
...
/*can-connect@2.0.0-pre.2#base/base*/
define('fixture-can-connect/base/base', [
    'require',
    'exports',
    'module',
    'fixture-can-connect/connect'
], function (require, exports, module) {
    var connect = require('fixture-can-connect/connect');
...
/*can-connect@2.0.0-pre.2#can-connect*/
define('fixture-can-connect/can-connect', [
    'require',
    'exports',
    'module',
    'fixture-can-connect/connect',
    'fixture-can-connect/base/base',
    'can-namespace'
], function (require, exports, module) {
    var connect = require('fixture-can-connect/connect');
    var base = require('fixture-can-connect/base/base');
    var ns = require('can-namespace');
    connect.base = base;
    module.exports = ns.connect = connect;
});
/*can-fixture@2.0.0-pre.0#helpers/getid*/
...
/*can-fixture@2.0.0-pre.0#helpers/legacyStore*/
define('can-fixture/helpers/legacyStore', [
    'require',
    'exports',
    'module',
    'can-fixture/helpers/getid',
    'fixture-can-set/src/set',
...
/*can-connect@2.0.0-pre.2#helpers/get-items*/
...
/*can-connect@2.0.0-pre.2#helpers/sorted-set-json*/
...
/*can-connect@2.0.0-pre.2#helpers/overwrite*/
...
/*can-connect@2.0.0-pre.2#helpers/set-add*/
define('fixture-can-connect/helpers/set-add', [
    'require',
    'exports',
    'module',
    'fixture-can-set/src/set'
...
/*can-connect@2.0.0-pre.2#helpers/get-index-by-id*/
...
/*can-util@3.10.14#js/is-function/is-function*/
...
/*can-util@3.10.14#js/is-plain-object/is-plain-object*/
...
/*can-util@3.10.14#js/deep-assign/deep-assign*/
...
/*can-connect@2.0.0-pre.2#helpers/clone-data*/
define('fixture-can-connect/helpers/clone-data', [
    'require',
    'exports',
    'module',
...
/*can-connect@2.0.0-pre.2#data/memory-cache/memory-cache*/
define('fixture-can-connect/data/memory-cache/memory-cache', [
    'require',
    'exports',
    'module',
    'fixture-can-connect/helpers/get-items',
    'fixture-can-connect/can-connect',
    'fixture-can-connect/helpers/sorted-set-json',
    'fixture-can-set/src/set',
    'fixture-can-connect/helpers/overwrite',
    'fixture-can-connect/helpers/set-add',
    'fixture-can-connect/helpers/get-index-by-id',
    'can-util/js/assign/assign',
    'fixture-can-connect/helpers/clone-data'
], function (require, exports, module) {
    ...
    var assign = require('can-util/js/assign/assign');
    var cloneData = require('fixture-can-connect/helpers/clone-data');
...
define('can-fixture/store', [
    ...
    'can-util/js/assign/assign',
    'can-util/js/is-array-like/is-array-like',
    'fixture-can-connect/data/memory-cache/memory-cache'
], function (require, exports, module) {
    var canSet = require('fixture-can-set/src/set');
    var connect = require('fixture-can-connect/can-connect');
    ...
    var assign = require('can-util/js/assign/assign');
    var isArrayLike = require('can-util/js/is-array-like/is-array-like');
    var dataMemoryCache = require('fixture-can-connect/data/memory-cache/memory-cache');
...
/*can-fixture@2.0.0-pre.0#fixture*/
define('can-fixture', [
    'require',
    'exports',
    'module',
